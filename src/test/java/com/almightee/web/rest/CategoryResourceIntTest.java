...
import com.almightee.domain.Category;
import com.almightee.repository.CategoryRepository;
import com.almightee.repository.search.CategorySearchRepository;
...
public class CategoryResourceIntTest {
     ...
     *
     * @see com.almightee.repository.search.CategorySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getPrice()).isEqualTo(DEFAULT_PRICE);
    ...
    public void updateCategory() throws Exception {
        ...
        assertThat(testCategory.getPrice()).isEqualTo(UPDATED_PRICE);
