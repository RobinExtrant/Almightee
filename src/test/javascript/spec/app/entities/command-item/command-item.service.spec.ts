...
describe('Service Tests', () => {
    describe('CommandItem Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(CommandItemService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/command-items';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a CommandItem', () => {
                service.create(new CommandItem(null)).subscribe(received => {
            ...
            it('should update a CommandItem', () => {
                service.update(new CommandItem(123)).subscribe(received => {
            ...
            it('should return a CommandItem', () => {
